    ...
    describe("#WeatherRoutes", () => {
        describe("#linkToGetWeather", () => {
            it("should reduce precision of geo coordinates", () => {
                expect(WeatherRoutes.linkToGetWeather({ countryCode: "US", location: { latitude: 40.7129822, longitude: -74.007205 }, query: "New York" })).toStrictEqual("/weather/US/40.712/-74.008/New%20York");
            });
        });
    });
});